...
do_sim = function(pos, cond, iters) {
  ...
  if(i == 1){
    write.table(results.cond, file = paste("../results/res_inter_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], ".dat", sep = ""), row.names=F, col.names=T)
  }
  
  if(i > 1){
    write.table(results.cond, file = paste("../results/res_inter_", results.cond[1,"cond"], "_", results.cond[1,"lambda1"], "_", results.cond[1,"lambda2"], "_", results.cond[1,"lambda3"], "_", results.cond[1,"alpha2"], "_", results.cond[1,"n"], ".dat", sep = ""), row.names=F, col.names=T, append=T)
  }
...
write.table(results.summarized, file = "../results/intercepts_summarized_results.dat", row.names=F, col.names=T)
