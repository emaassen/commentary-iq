...
getwd()
setwd("C:/Users/s421506/tiu/research/mgcfa-simulations/intercepts/results")
...
write.table(results.summarized, file = "../intercepts_summarized_results.dat", row.names=F, col.names=T)
